...
** Supported Emacs versions
   Attempts have been made to make this config compatible with 25.3+. However, they are half-hearted and some features are 27+ or even 28+ only.
...
** macOS Menus Need Two Clicks
   Sometimes a problem arises where the menus in the macOS menu bar for Emacs don't respond to the first mouse click, but they do respond to the second. This is a bug in Emacs but it can be mitigated with these steps.
